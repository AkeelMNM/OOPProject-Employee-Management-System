...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
		<div class="left4">
			<div class="btn-group" style="padding-top:50px;">
					...
					<a href="#"><button class="buttoninsidemenu ">View Employees Attendance in Department</button></a>
					<a href="${pageContext.request.contextPath}/Manager/Manager View Employees AttendanceStatus.jsp"><button class="buttoninsidemenu ">View Employees Attendance Status in Department</button></a>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
		...
		String DepartmentID = attendanceService.getDepartmentID(EmpName); //Getting Department Name
		ArrayList<Attendance> attendanceList = attendanceService.getDepartmentAttendance(DepartmentID); //Getting Department Employees Attendance
		...
		<tr>
				<th colspan="6"class="tbhd">Employee Attendance</th>
		</tr>
		<tr>
				<th>Employee Name</th>
