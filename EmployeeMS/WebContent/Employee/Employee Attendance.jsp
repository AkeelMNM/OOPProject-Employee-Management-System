...
<meta charset="ISO-8859-1">
		<link rel="stylesheet" type = "text/css" href="${pageContext.request.contextPath}/CSS & javaScript/EmployeeStyles.css">
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
		<div class="left4" style="height:410px;">
			<div class="btn-group" style="padding-top:50px;">
					...
					<a href="${pageContext.request.contextPath}/Employee/Employee View Attendance.jsp"><button class="buttoninsidemenu ">View Attendance</button></a>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->	
		...
		<tr>
			...
			<% 
				...
				%>
					...
					<tr colspan="2">
						<td><input type="submit" value="Sign in" class="signbutton">
		...
		if(EnTime == null){ //if Emplyee didn't Sign Out
		%>
			<tr>
			...
			<tr colspan="2">
					<td><input type="submit" value="Sign Out" class="signbutton">
					<input type="hidden" name="attendanceID" value="<%=AttendanceID%>">
					<input type="hidden" name="empID" value="<%=EmployeeID%>">
					<input type="hidden" name="Role" value="Employee">
					</td><td></td>
