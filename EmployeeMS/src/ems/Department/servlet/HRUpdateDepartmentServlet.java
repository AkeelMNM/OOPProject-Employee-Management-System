...
/**
 * Servlet implementation class HRUpdateDepartmentServlet
 */
/**
 * @author Zumry
 * IT NO:IT19175126
 *
 */
@WebServlet("/HRUpdateDepartmentServlet")
public class HRUpdateDepartmentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HRUpdateDepartmentServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HRDepartmentAndManagerServiceInterface updateDetails = new HRDepartmentAndManagerServiceImpt();
		updateDetails.updateDepartment(DepID, dep);
